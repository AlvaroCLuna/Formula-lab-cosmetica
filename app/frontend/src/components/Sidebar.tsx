import { Archive, BarChart3, Beaker, BookOpen, Bot, Boxes, Calculator, ClipboardCheck, FileStack, FlaskConical, GitBranch, Handshake, LayoutDashboard, LibraryBig, PackageSearch, ShoppingCart, UploadCloud, Workflow } from "lucide-react";
