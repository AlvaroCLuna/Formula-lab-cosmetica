import { Archive, Beaker, BookOpen, Boxes, Calculator, ClipboardCheck, FileStack, FlaskConical, LayoutDashboard, LibraryBig, PackageSearch, ShoppingCart, UploadCloud } from "lucide-react";
