import { Archive, BarChart3, Beaker, BookOpen, Bot, Boxes, Calculator, ClipboardCheck, FileStack, FlaskConical, FlaskRound, GitBranch, Handshake, LayoutDashboard, LibraryBig, PackageSearch, ShoppingCart, UploadCloud, Workflow } from "lucide-react";
...
const items = [
  ...
  { id: "studio", label: "Studio BPM", icon: Workflow },
  { id: "piloto", label: "Laboratorio Piloto", icon: FlaskRound },
